...
class User 
{
    ...
    {
        try {
            // Get user avatar before deletion to clean up custom uploads
    ...
    private function deleteOldCustomAvatar($oldAvatar) 
    {
        ...
        // Don't delete preset avatars
        if (strpos($oldAvatar, '/images/avatars/') !== false) {
            return;
        }
